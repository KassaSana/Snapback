...
TEST_CASE("IPC contract: canonical set has 68 handler commands") {
    // 61 -> 65 with Roadmap 9.14's import path; 66 with Roadmap 2.8; 68 with Roadmap 10.14 file dialogs.
    CHECK(load_expected_commands().size() == 68);
}
