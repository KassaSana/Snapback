...
TEST_CASE("IPC contract: canonical set has 76 handler commands") {
    ...
    // 76 reads the saved automatic label for the end-of-session check-in.
    CHECK(load_expected_commands().size() == 76);
}
