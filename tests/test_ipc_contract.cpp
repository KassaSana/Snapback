...
TEST_CASE("IPC contract: canonical set has 72 handler commands") {
    ...
    // the daily focus series behind the Review trend surfaces.
    CHECK(load_expected_commands().size() == 72);
}
