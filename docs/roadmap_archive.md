...
## Lifted 2026-09-22 (Roadmap 12.8)

Completed items and their `(original finding)` history blocks, moved out of
[`ROADMAP.md`](ROADMAP.md) verbatim so that file carries open work only. IDs, dates, and
wording are unchanged; the only edit is that a few of these pointed at ROADMAP.md's own
"Done archive" anchor, which they are now inside, so that link is plain text here.
Entries from the 2026-08-19 split are above and may cover the same ID from an earlier date —
both are true as of their own date.

### Tier 6 — CI health — lifted from the live backlog 2026-09-22

- **6.1 — DONE, CI-confirmed 2026-07-22.** Moved to the Done archive.
...
- **6.4 — DONE, CI-confirmed 2026-07-22.** Moved to the Done archive.
...
### Tier 0 — Finish the port's last gaps — lifted from the live backlog 2026-09-22
...
### Tier 7 — Correctness & product findings (2026-07-20 staff review) — lifted from the live backlog 2026-09-22
...
### Tier 8 — Security hardening (2026-07-20 staff review) — lifted from the live backlog 2026-09-22
...
### Tier 1 — Ship a polished Windows-first v1 — lifted from the live backlog 2026-09-22
...
### Tier 2 — Product & ML depth — lifted from the live backlog 2026-09-22
...
### Tier 3 — Cross-platform breadth & packaging — lifted from the live backlog 2026-09-22
...
### Tier 5 — Open findings from the 2026-07-20 engine/storage audit — lifted from the live backlog 2026-09-22
...
### Tier 4 — Engineering quality & hardening (cross-cutting) — lifted from the live backlog 2026-09-22
...
### Tier 9 — Ship a v1 (release readiness) — lifted from the live backlog 2026-09-22
...
### Tier 11 — Test infrastructure — lifted from the live backlog 2026-09-22
...
### Tier 12 — Documentation truth — lifted from the live backlog 2026-09-22

- **12.1 — DONE 2026-07-23.** Moved to the Done archive. The map now
...
- **12.2 — DONE 2026-07-23.** Moved to the Done archive. Ten false claims
...
- **12.3 — DONE 2026-07-23.** Moved to the Done archive.
...
- **12.4 — DONE 2026-07-23.** Moved to the Done archive.
...
### Tier 13 — Model lifecycle (breaking down 2.3) — lifted from the live backlog 2026-09-22
...
### Additions to existing tiers — lifted from the live backlog 2026-09-22
...
- **12.5 — DONE 2026-07-23.** Moved to the Done archive. `test_local.sh`
...
### Carried in the live backlog without a completion marker (found 2026-09-22)

`2.16`'s original statement sat in ROADMAP.md's Tier 2 with no `(original finding)` marker
and no DONE date, directly above the entry recording it **DONE 2026-08-27** — so the live
backlog listed a finished item as if it were open. Moved here unchanged; the dated DONE
entry above is the record of what shipped.
...
### Roadmap 12.8 — the restructure itself (2026-09-22)

- **12.8 — DONE 2026-09-22. Move the Done archive and postmortems out of the backlog.** `S` `decision`
  Answered yes, and executed conservatively: items were relocated verbatim, not rewritten.

  **What moved.** 128 blocks, 3,317 lines, out of a 5,320-line file — every item whose head
  said DONE or CLOSED, plus the 26 `(original finding)` / `(earlier state)` /
  `(reopened finding)` history blocks whose parent item was already complete. `ROADMAP.md` is
  now 1,914 lines and holds open work only. IDs, dates and wording are unchanged; the single
  edit made to a moved block was to flatten its link to this file's own "Done archive" anchor,
  which it is now inside.

  **The status system.** Every open item's first tag is exactly one of `proposed`, `accepted`
  or `in progress`. `proposed` is the default and the large majority — a finding with good
  evidence that nobody has agreed to build. `accepted` requires a citable agreement: a row in
  the file's own "Start here" sequence, or a release blocker in an ADR. `in progress` means
  part of it landed and the item says which part. That ordering is the point: **promotion is a
  visible edit someone makes on purpose**, which is exactly what commit 907517d bypassed when
  eleven unverified items arrived looking like plans.

  `scripts/check_roadmap_status.py` enforces both halves — one status per open item, and no
  DONE item left in the live file. It does **not** judge which status is right; a guard that
  tried would either be wrong or become a second backlog.

  **Two things the pass found rather than fixed structurally.** `2.16`'s original statement
  was sitting in Tier 2 with no completion marker, directly above the entry recording it
  **DONE 2026-08-27** — so the live backlog had been listing a finished item as open. It is
  filed below under its own heading rather than deleted. And `13.8`'s `(original finding)`
  block nearly followed the other history into this file while `13.8` itself is still open; it
  was put back beside its item, because an open item's first statement is context, not history.
  ...
  - **12.8 — Move the Done archive and the postmortems out of this file.** `S` `decision`
    ...
    [archive](roadmap_archive.md), and the DONE entries kept because their explanation still
