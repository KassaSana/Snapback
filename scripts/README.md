...
| `check_roadmap_status.py` | any OS | verifies every open item in `docs/ROADMAP.md` names exactly one of `proposed`/`accepted`/`in progress`, and that no DONE item is left in the live backlog |
